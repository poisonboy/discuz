...
if(isset($_SERVER['HTTP_REFERER']) && strncmp($_SERVER['HTTP_REFERER'], 'https://servicewechat.com/', 26) === 0) {
	$_SERVER['HTTP_REFERER'] = $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'];
}
...
$modules = array('extends', 'buyattachment', 'buythread', 'checkpost', 'connect',
	...
	'showactivity', 'bestanswer', 'forummisc', 'checkcookie', 'checknewpm', 'viewcomment', 'plugin', 'forumguide', 'code2session', 'group', 'groupuser', 'forum', 'threadclass', 'support', 'activityapplies', 'portalcomment', 'report', 'favorite','userrank' ,'search', 'oauths');
