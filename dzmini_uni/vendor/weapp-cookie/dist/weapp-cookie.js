(function (global, factory) {
  ...
  'use strict'; // 22.1.3.4 Array.prototype.entries()
  ...
  var core_isIterable = _core.isIterable = function (it) {
    var O = Object(it);
    return O[ITERATOR$1] !== undefined || '@@iterator' in O // eslint-disable-next-line no-prototype-builtins
  ...
  */
  ...
  var Cookie = function () {
    ...
    _createClass(Cookie, [{
      ...
      value: function set() {
        ...
        if (cookie) {
          _Object$assign(this, cookie); // 更新设置时间
  ...
  var CookieStore = function () {
    ...
    function CookieStore() {
      _classCallCheck(this, CookieStore); // storageKey
    ...
    _createClass(CookieStore, [{
      ...
      value: function get() {
        ...
        var path = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '/'; // 获取 cookie
      ...
      value: function set() {
        ...
        var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {}; // 构建 Cookie 实例
      ...
      value: function getCookie() {
        ...
        var cookie = void 0; // 获取 cookie scope 域名数组
        ...
        try {
          for (var _iterator3 = _getIterator(this.__cookiesMap.entries()), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var _step3$value = _slicedToArray(_step3.value, 2),
                key = _step3$value[0],
                cookies = _step3$value[1]; // 如果有域名，则根据域名过滤
        ...
        try {
          for (var _iterator4 = _getIterator(this.__cookiesMap.entries()), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            var _step4$value = _slicedToArray(_step4.value, 2),
                key = _step4$value[0],
                cookies = _step4$value[1]; // 如果有域名，则根据域名过滤
            ...
            try {
              for (var _iterator5 = _getIterator(cookies.values()), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                var cookie = _step5.value; // 筛选符合 path 条件并且未过期的 cookie
      ...
      value: function setCookiesArray() {
        ...
        this.__cookiesMap = this.__cookiesMap || new _Map(); // Cookie 数组转换 Map 对象
      ...
      value: function parse() {
        var setCookieStr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
        var domain = arguments[1]; // parse

        var cookies = setCookie.parse(setCookie.splitCookiesString(setCookieStr)); // 转换为 Cookie 对象
